 ...
 * @author Jorge
 */
public class Agregar_Genero extends javax.swing.JPanel {

    /** Creates new form Usuarios */
    public Agregar_Genero() {
        initComponents();
        //Mando a llamar el metodo del LOOK & FEEL
        IniStyles();
        //
        TextPrompt txtU = new TextPrompt("Genero", txt_Genero);
    ...
    //Metodo que contiene los estilos del LOOK & FEEL
     private void IniStyles(){
         ...
         txt_Genero.putClientProperty( "JComponent.roundRect", true );
         //Estilo del boton
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/generos128px.png"))); // NOI18N
